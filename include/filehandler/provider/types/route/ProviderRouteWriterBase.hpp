#ifndef _FILEHANDLER_PROVIDER_PROVIDERROUTEWRITERBASE_
#define _FILEHANDLER_PROVIDER_PROVIDERROUTEWRITERBASE_
...
#endif /* _FILEHANDLER_PROVIDER_PROVIDERROUTEWRITERBASE_ */
